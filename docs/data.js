    ...
    { id: "oct09", date: "2026-10-09", dow: "Friday", half: "london",
      ...
      items: [
        ...
        { time: "Evening", name: "Collect the rental car at Heathrow",
          ...
          detail: "One day: out Saturday morning, back Saturday evening. Take the excess waiver and confirm the car is ULEZ-compliant." },
    ...
    { id: "oct10", date: "2026-10-10", dow: "Saturday", half: "london",
      ...
      items: [
        ...
        { time: "4:00pm", name: "Drive back to the Courtyard Heathrow",
          ...
          detail: "Same room as this morning. Return the car at the terminal, or keep it overnight if the rate is the same.",
          maps: "Courtyard by Marriott London Heathrow Airport, 1 Nobel Drive, Harlington, Hayes UB3 5EY", ll: "51.4934,-0.4192" },
        { time: "Evening", name: "Dinner, and where depends on how the day went",
          ...
          detail: "Low-key: pubs and chains on the Bath Road strip. Worth the trip: Dishoom Covent Garden, 30 min on the Elizabeth line. Book either way.",
    ...
    { id: "oct11", date: "2026-10-11", dow: "Sunday", half: "london",
      ...
      items: [
        ...
        { time: "Morning", name: "Sacrament meeting at the Hyde Park Chapel",
          ...
          detail: "64-68 Exhibition Road, South Kensington. Confirm the meeting time on the ward or stake page beforehand.",
    ...
    { id: "oct12", date: "2026-10-12", dow: "Monday", half: "london",
      ...
      items: [
        { time: "9:30am", name: "Westminster Abbey",
          ...
          dur: "2 hrs",
          detail: "About 30 GBP each. Opens 9:30am - book a timed slot online. Audio guide included.",
        ...
        { time: "11:45am", name: "Walk to the river, and lunch",
          ...
          detail: "Tourist-priced around Westminster and Embankment. Better 10 minutes into St James's or toward Strand.",
        ...
        { time: "2:00pm", name: "St Paul's Cathedral, and the dome",
          ...
          dur: "1.5-2 hrs",
          detail: "About 26 GBP each. The dome is 528 narrow spiral steps, one-way with no bail-out. Last dome entry is well before closing.",
    ...
    { id: "oct14", date: "2026-10-14", dow: "Wednesday", half: "iceland",
      ...
      items: [
        ...
        { time: "11:45", name: "Gullfoss",
          ...
          dur: "30-40 min",
          detail: "Free, large car park, cafe. Quick stop - the glacier truck leaves from this car park.",
        ...
        { time: "13:00", name: "Into the Glacier, departing Gullfoss",
          ...
          detail: "Thermal suits, helmets and crampons provided. Wear warm layers and waterproof boots. Take the Gullfoss departure, not Reykjavík.",
    ...
    { id: "oct15", date: "2026-10-15", dow: "Thursday", half: "iceland",
      ...
      items: [
        ...
        { time: "Evening", name: "Lava Show, Vík",
          ...
          dur: "About 1 hr",
          detail: "Book ahead. Pick a session that gets you back to the cabin before full dark.",
    ...
    { id: "oct17", date: "2026-10-17", dow: "Saturday", half: "iceland",
      ...
      items: [
        ...
        { time: "9:00am", name: "Blue Lagoon",
          ...
          detail: "Comfort admission: entry, towel, silica mud mask and a drink. Timed entry, pre-booked - 9:00am slot. Ninety minutes is a full visit.",
        ...
        { time: "11:00am", name: "Out, dried off, and pointed at the coast",
          ...
          detail: "Nothing is tight today. Stay in until 11:30 and shorten the coast drive if you want." },
        ...
        { time: "1:00pm", name: "Fuel up, return the car, check in at KEF",
          ...
          detail: "Refuel before you hand the car back. Two and a half hours before departure.",
          maps: "Keflavik International Airport, Iceland", ll: "63.9850,-22.6056" },
