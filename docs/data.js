...
const TRIP = {
  ...
  days: [
    ...
    { id: "oct12", date: "2026-10-12", dow: "Monday", half: "london",
      ...
      items: [
        ...
        { time: "11:45am", name: "Lunch: Dishoom Covent Garden",
          book: ["fs8"],
          travel: "20-25 min on foot from the Abbey, past Whitehall and Trafalgar Square",
          dur: "About 90 min including the walk",
    ...
    { id: "oct13", date: "2026-10-13", dow: "Tuesday", half: "iceland",
      ...
      items: [
        ...
        { time: "2:15pm", name: "Valahnúkamöl and Reykjanesviti",
        ...
        { time: "2:55pm", name: "Bridge Between Continents",
        ...
        { time: "3:55pm", name: "Check into the Fosshotel Baron",
          book: ["fs22"],
    ...
    { id: "oct14", date: "2026-10-14", dow: "Wednesday", half: "iceland",
      ...
      items: [
        { time: "8:45", name: "Þingvellir National Park",
    ...
    { id: "oct17", date: "2026-10-17", dow: "Saturday", half: "iceland",
      ...
      items: [
        { time: "9:00am", name: "Check out and drive to Blue Lagoon",
        ...
        { time: "9:30am", name: "Blue Lagoon",
          book: ["fs14", "wo8"],
          travel: "You are here",
          dur: "2.5 hrs in the water",
          detail: "Comfort admission: entry, towel, silica mud mask and a drink. Timed entry, pre-booked - 9:30am slot. Out by 12:00.",
        ...
        { time: "12:30pm", name: "Fuel up, return the car, check in at KEF",
  ...
  checklists: [
    ...
    { id: "four-six", label: "Four to six weeks out", promoteAt: 42, overdueAt: 7, items: [
      ...
      { id: "fs14", text: "Book Blue Lagoon for Sat Oct 17 - Comfort x2, a 9:30am slot, plus the luggage hold. Read the cancellation terms; an eruption closure should be refundable", extra: true },
