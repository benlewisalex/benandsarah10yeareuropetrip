...
const TRIP = {
  ...
  days: [
    ...
    { id: "oct17", date: "2026-10-17", dow: "Saturday", half: "iceland",
      ...
      items: [
        { time: "9:30am", name: "Check out and drive to Blue Lagoon",
        ...
        { time: "10:00am", name: "Blue Lagoon",
          book: ["fs14", "wo8"],
          travel: "You are here",
          mode: "none",
          dur: "2.5 hrs in the water",
          detail: "Comfort admission: entry, towel, silica mud mask and a drink. Timed entry, pre-booked - 10:00am slot. Out by 12:30.",
  ...
  checklists: [
    ...
    { id: "four-six", label: "Four to six weeks out", promoteAt: 42, overdueAt: 7, items: [
      ...
      { id: "fs14", text: "Book Blue Lagoon for Sat Oct 17 - Comfort x2, a 10:00am slot, plus the luggage hold. Read the cancellation terms; an eruption closure should be refundable", extra: true },
